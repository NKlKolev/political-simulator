...
def render_main_menu():
    ...
    <div style="text-align:center;padding:3rem 2rem 1rem">
      ...
      <p class="splash-tagline">
        Govern Pustinyakovo day by day. Plan ahead, lobby individual MPs, push bills through
        five parliamentary stages, manage your fragile coalition, survive crises, and win re-election.
        Every day brings <b style="color:#FBBF24">4 Action Points</b> to spend wisely.
      </p>
    </div>
